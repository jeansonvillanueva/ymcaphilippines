...
export default function Card_One() {
  ...
  return (
    ...
    >
      ...
      📍 Baguio: March 2–4, 2026
      Educators from various DepEd schools actively participated in workshops and hands-on activities, discovering how AI can ease their daily tasks as teachers  from creating reports and lesson plans to enhancing classroom efficiency. 
